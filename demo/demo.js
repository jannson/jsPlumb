jsPlumb.ready(function () {
  ...
  //
  var initNode = function (el, type = 'task') {
  ...
  var newNode = function (type) {
    ...
    d.className = type === 'switch' ? "w diamond" : "w";
    d.id = id;
    d.innerHTML = `<div class="text">${id.substring(0, 7)}</div><div class="ep"></div>`;
    d.style.left = "20px";
    d.style.top = "20px";
